...
public class XMPP {
	...
	public static void sendMessage(String message, XMPPType type) {
		ConfigurationData cd = External.ym.getConfigurationData();
	...
	public static void send(boolean send, String message) {
		if (send) {
