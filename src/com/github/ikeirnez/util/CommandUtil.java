...
public class CommandUtil extends DataManipulator {
    ...
    public void showHelp(CommandSender s, String[] args, String alias) {
        ...
        if (args.length == 2 && args[1].equalsIgnoreCase("sign") && s.hasPermission("za.create")) {
            ...
            sb.append(r + Local.BASE_STRING.getSetting() + " " + gr + "This must be at the top of any ZA command sign");
            sb.append(r + Local.BASE_JOIN_STRING.getSetting() + " " + gr + "When clicked adds a player to a ZA game");
            sb.append(r + Local.BASE_AREA_STRING.getSetting() + " " + gr + "When clicked unlocks a ZA area");
            sb.append(r + Local.BASE_PERK_STRING.getSetting() + " " + gr + "When clicked gives a perk");
            sb.append(r + Local.BASE_ENCHANTMENT_STRING.getSetting() + " " + gr + "When clicked enchants an item in your hand");
            sb.append(r + Local.BASE_WEAPON_STRING.getSetting() + " " + gr + "When clicked gives a weapon");
            return;
