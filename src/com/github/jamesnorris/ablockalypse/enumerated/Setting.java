...
public enum Setting {
    ...
    LAST_STAND_HEALTH_THRESHOLD("lastStandThreshold", Double.class),
    ...
    MAX_PATHFINDER_NODES("maxPathfinderNodes", Integer.class),
    ...
    POWERUP_CHANCE("powerupChance", Double.class),
    ...
    Setting(String name, Class<?> type) {
        ...
        if (object == null) {
            Ablockalypse.getTracker().error("The value for <" + toString() + ">, which uses the value of <" + name + "> in the configuration is null and/or missing!", 100 / values().length);
        }
    }
