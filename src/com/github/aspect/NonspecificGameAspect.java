...
public class NonspecificGameAspect extends PermanentAspect implements GameAspect, Blinkable {
    ...
    @SuppressWarnings("serial") public NonspecificGameAspect(final Location location) {
    ...
    protected void refreshBlinker() {
        blinkerTask.cancel();
        blinkerTask = new BlinkerTask(getDefiningBlocks(), correctlySetup ? correctSetupColor : incorrectSetupColor, 30, (Boolean) Setting.BLINKERS.getSetting() && correctlySetup);
    }
}
