...
public class ZAPlayer extends ZACharacter {
    ...
    public ZAPlayer(SavedVersion savings) {
        ...
        beforeGame = new PlayerState((SavedVersion) savings.get("before_game_state"));
        beforeLS = new PlayerState((SavedVersion) savings.get("before_last_stand_state"));
        if (!player.isOnline()) {
    ...
    public void loadSavedVersion(SavedVersion savings) {
